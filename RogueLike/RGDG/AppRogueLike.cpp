...
WCHAR szTitle[100] = TEXT("RogueLike");    // 제목 표시줄 텍스트입니다.
WCHAR szWindowClass[100] = TEXT("RogueLike1");       // 기본 창 클래스 이름입니다.
    ...
    _In_ int       nCmdShow)
{
    ...
    wc.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ROGUELIKE));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CLOSE:
        if (IDYES == MessageBoxW(NULL, TEXT("게임 종료"), TEXT("알림"), MB_YESNO))
        {
            runWnd = false;
        }
        break;
