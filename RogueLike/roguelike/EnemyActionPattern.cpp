...
//			n /= len;
//			iPoint p = pc->playerPosition + iPointMake(HALF_OF_TEX_WIDTH,HALF_OF_TEX_HEIGHT) - e->enemyPos + et;
...
bool commonAttack(MonsterData* enm, float dt)
{
	...
	if (e->atkMotion && e->atkMotionTime
		> 0.0f - e->meleeAtkSpeed * 0.4f && e->atkMotionTime < 0.0f - e->meleeAtkSpeed * 0.3f)
	{
		setLineWidth(10);
		setRGBA(1, 0, 0, 1);
		drawLine(egdp + et,
